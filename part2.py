...
while True:
    try:
        game_count = int(input(f"Okay {name}, how many rounds of game would you like to play? >> "))
...
while game_count > 0:
    ...
    if userDecideWordLength:
        ...
        print(
            f"That's fine {name}, it's hard for me to decide too, but here it is")
